...
RUN apt-get -y update && apt-get upgrade -y && apt-get install -y python-pip libxml2-dev libxslt-dev lib32z1-dev python-lxml
...
RUN rm -rf splunk-appinspect-1.7.0.tar.gz
RUN apt-get clean
